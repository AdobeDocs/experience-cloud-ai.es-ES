...
| --- | --- | --- |
| [Adobe Marketing Agent para [!DNL Microsoft 365 Copilot]](ama-ms.md) | Recupere instantáneamente información de marketing de Adobe Experience Platform en aplicaciones de [!DNL Microsoft 365] como [!DNL Teams], [!DNL Word], [!DNL Powerpoint] y [!DNL Excel]. Con este agente, puede mantener el historial de chat en todas las aplicaciones y continuar sin problemas su conversación mientras trabaja. | |
...
Todos los usuarios tienen acceso al asistente de IA y a los agentes de Experience Platform asociados.
