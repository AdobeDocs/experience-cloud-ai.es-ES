---
title: Acceso a las herramientas de CX Coworker Gateway
description: Confirme la disponibilidad del producto, la habilitación de la organización y los permisos antes de utilizar las herramientas de Adobe CX Coworker Gateway.
...
# Acceso a las herramientas de CX Coworker Gateway {#mcp-access}
...
>[!IMPORTANT]
>
>Para poder utilizar las herramientas de CX Coworker Gateway, su organización de Adobe debe estar habilitada. Si su organización aún no tiene acceso, póngase en contacto con el equipo de cuenta de Adobe para solicitar la habilitación de su organización.
...
Para las herramientas de producto de Beta o de versiones limitadas, póngase en contacto con el representante de su cuenta de Adobe y especifique qué herramientas de producto de Adobe for CX Coworker Gateway desea utilizar. Su representante puede coordinar la activación del producto y confirmar cuando su organización de Adobe esté lista.
...
Siguiente: [Instale Adobe CX Coworker Gateway](install.md).